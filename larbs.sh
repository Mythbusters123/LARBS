...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/Mythbusters123/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/Mythbusters123/LARBS/master/progs.csv"
